...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', nargs=1, default=["/home/kawahara/gtrap/examples/picklcslc/100/npz"],help='directory containing train sets generated by gtls_slctess.', type=str)
    parser.add_argument('-f', nargs=1, default=["pulsenetA_train02019_08_18.h5"],help='pulsenet hdf5 file.', type=str)
...
#    crit=0.995
    ...
    for j,f in enumerate(flist[mask]):
        ...
        plt.savefig("pred/pred"+ticn+".png")
        plt.close()
