...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', nargs=1, default=["pulsenetCS_train12019_09_02.h5"],help='pulsenet hdf5 file.', type=str)
...
#    crit=0.995
    ...
    for j,f in enumerate(flist[mask]):
        ...
        time, flux, q, cno, ra, dec, tic1, sector1, camera1, CCD1, cnts, apkbg=tesstic.read_tesstic(hdf)        
